...
const sourceIsNotListFeature = computed(() => {
  return !modelValue.value.builder_url?.startsWith('/api/v1/dictionaries') && modelValue.value.builder_url !== undefined && modelValue.value.builder_url !== ""
})
...
<i18n lang="json">
{
  ...
  "pl": {
    ...
    "singleOptionAutoSelect": "Autowybór wartości",
